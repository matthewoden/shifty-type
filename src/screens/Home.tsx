            ...
            <div className="flex flex-col gap-3.5 w-full max-w-xs">
                {!isTutorialDone() && (
                    ...
                    >
                        ...
                        <span className="text-lg font-extrabold text-dim">
                            ›
                        </span>
                    </button>
                )}
                {gameCount > 0 && (
                    ...
                    >
                        ...
                        <span className="flex-1 min-w-0">
                            <span className="block font-extrabold text-base text-ink-strong">
                                Your games
                            </span>
                            <span className="block font-bold text-caption text-dim">
                                {gamesSubtitle}
                            </span>
                        </span>
                        {needsYou > 0 && (
                            <span className="min-w-6 h-6 px-1.5 pt-0.5 rounded-full bg-p2 text-white font-extrabold text-ui flex items-center justify-center shadow-[0_2px_0_var(--color-p2-lip)]">
                                {needsYou}
                            </span>
                        )}
                        <span className="text-lg font-extrabold text-dim">
                ...
                <div className="flex justify-center gap-1 items-center">
                    ...
                    {isTutorialDone() && (
                        <>
                            <span className="text-dim text-ui font-extrabold">
                                ·
                            </span>
                            <Button
                                variant="text"
