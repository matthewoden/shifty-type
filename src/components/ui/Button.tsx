...
> = {
    ...
    cta: {
        base: "rounded-2xl font-extrabold active:translate-y-0.5 disabled:opacity-50 disabled:active:translate-y-0 flex items-center justify-center gap-2 pt-0.5",
